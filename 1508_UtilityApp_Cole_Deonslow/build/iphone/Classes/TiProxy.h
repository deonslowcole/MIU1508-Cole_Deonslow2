...
//Rare exceptions to indicate a bug in the _k1508_utilityapp_cole_deonslow code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1508_UtilityApp_Cole_Deonslow proxies.
 */
