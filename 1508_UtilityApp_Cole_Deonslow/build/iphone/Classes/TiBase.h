...
// in simulator we redefine to format for k1508_UtilityApp_Cole_Deonslow Developer console
...
{\
	NSString * exceptionName = [@"org.k1508_utilityapp_cole_deonslow." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1508_utilityapp_cole_deonslow";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1508_UtilityApp_Cole_DeonslowNativeItemNone = -1, 
	UIk1508_UtilityApp_Cole_DeonslowNativeItemSpinner = -2,
	UIk1508_UtilityApp_Cole_DeonslowNativeItemProgressBar = -3,
	
	UIk1508_UtilityApp_Cole_DeonslowNativeItemSlider = -4,
	UIk1508_UtilityApp_Cole_DeonslowNativeItemSwitch = -5,
	UIk1508_UtilityApp_Cole_DeonslowNativeItemMultiButton = -6,
	UIk1508_UtilityApp_Cole_DeonslowNativeItemSegmented = -7,
	
	UIk1508_UtilityApp_Cole_DeonslowNativeItemTextView = -8,
	UIk1508_UtilityApp_Cole_DeonslowNativeItemTextField = -9,
	UIk1508_UtilityApp_Cole_DeonslowNativeItemSearchBar = -10,
	
	UIk1508_UtilityApp_Cole_DeonslowNativeItemPicker = -11,
	UIk1508_UtilityApp_Cole_DeonslowNativeItemDatePicker = -12,
	
	UIk1508_UtilityApp_Cole_DeonslowNativeItemInfoLight = -13,
	UIk1508_UtilityApp_Cole_DeonslowNativeItemInfoDark = -14,
	
	UIk1508_UtilityApp_Cole_DeonslowNativeItemDisclosure = -15,
	
	UIk1508_UtilityApp_Cole_DeonslowNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1508_UtilityApp_Cole_Deonslow instances of
