...
/**
 Base class for all k1508_UtilityApp_Cole_Deonslow views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1508_UtilityApp_Cole_Deonslow view hierarchy (such as wrapped iOS UIViews) was touched.
