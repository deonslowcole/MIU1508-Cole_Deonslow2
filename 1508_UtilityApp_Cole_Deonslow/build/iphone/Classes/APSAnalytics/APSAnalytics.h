 ...
 * to send analytic data that can be viewed on the k1508_UtilityApp_Cole_Deonslow Dashboard.
 *
 * For information on getting started with k1508_UtilityApp_Cole_Deonslow Platform Services,
