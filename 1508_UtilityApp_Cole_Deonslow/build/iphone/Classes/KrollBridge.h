...
@interface k1508_UtilityApp_Cole_DeonslowObject : KrollCoverageObject {
#else
@interface k1508_UtilityApp_Cole_DeonslowObject : KrollObject {
#endif
@private
...
extern NSString * k1508_UtilityApp_Cole_Deonslow$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1508_UtilityApp_Cole_DeonslowObject *_k1508_utilityapp_cole_deonslow;
    KrollObject* console;
	BOOL shutdown;
