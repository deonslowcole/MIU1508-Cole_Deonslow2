...
/**
 The base class for all k1508_UtilityApp_Cole_Deonslow modules
 */
...
/**
 k1508_UtilityApp_Cole_Deonslow Platform calls this method on startup.
 */
-(void)startup;

/**
 k1508_UtilityApp_Cole_Deonslow Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 k1508_UtilityApp_Cole_Deonslow Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 k1508_UtilityApp_Cole_Deonslow Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 k1508_UtilityApp_Cole_Deonslow Platform calls this method on resume.
 @param sender The sender of the event.
 */
