...
//@interface k1508_UtilityApp_Cole_DeonslowObject : NSObject
//@end

@interface k1508_UtilityApp_Cole_DeonslowObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1508_UtilityApp_Cole_DeonslowObject class]])
		{
			for (NSString *key in [[(k1508_UtilityApp_Cole_DeonslowObject*)o modules] allKeys])
			{
